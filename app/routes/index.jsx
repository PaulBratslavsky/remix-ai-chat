          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            <div className="absolute inset-0">
              <img
                ...
                src="https://images.pexels.com/photos/8097110/pexels-photo-8097110.jpeg"
                alt="AI Powered Chatbot"
              />

              <div className="absolute inset-0 bg-teal-300 mix-blend-multiply" />
            </div>
            <div className="relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pb-20 lg:pt-32">
              ...
              <span className="mx-auto mt-6 max-w-lg text-center text-xl text-teal bg-white sm:max-w-3xl rounded-md px-3 py-1">
